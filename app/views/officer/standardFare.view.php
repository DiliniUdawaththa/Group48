    ...
    <div class="interface">
        <div class="navi">
            <div class="navi1">
                ...
                <div class="operation">
                    <a href="<?=ROOT?>/officer/standardFare_insert/"><button type="button" class="button-style" id="plus">Add New</button></a>
                </div>
        </div>
                ...
                <table>
                    ...
                    <?php foreach ($rows as $row) : ?>
                        <tr class="data">
                            ...
                            <td class="td_button">
                            <a href="<?=ROOT?>/officer/standardFare_update/<?=$row->Fid?>"><button class="update_btn"><i class="fa-solid fa-pen-to-square" style="color: black;"></i></i></button></a>
                            <a href="<?=ROOT?>/officer/standardFare_delete/<?=$row->Fid?>"><div class="dltbutton"><button class="delete_btn"><i class="fa-solid fa-trash" style="color: black;"></i></div></button>
                            <a href="<?=ROOT?>/officer/standardFare_view/"<?=$row->Fid?>><button class="detail_btn"><i class="fa-solid fa-circle-info" style="color: black;"></i></button></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
