    ...
    <div class="main">
        <div class="sidebar">
            ...
            <div class="items">
                ...
                <a href="<?=ROOT?>/officer/standardFare" class="link"><div class="linkbutton1"><i class="fa-solid fa-tag"></i>Standard Fare</div></a>
                ...
                <div class="officer_form">
                    <form name="addStandardFare" action="" method="post" onsubmit="return validateForm()">
                        <div class="officer_box">
                            ...
                            <input value="<?= set_value('vehicletype') ?>" list="vehicletype_list" name="vehicletype" id="vehicletype" required>
                            ...
                            <input value="<?= set_value('faretype') ?>" list="faretype_list" name="faretype" id="faretype" required>
                            ...
                            <input value="<?= set_value('fare') ?>" type="text" name="fare" class="<?=!empty($errors['fare']) ? 'error':'';?>" required>
                            ...
                            <input value="<?= set_value('updatedby') ?>" type="text" name="updatedby" class="<?=!empty($errors['updatedby']) ? 'error':'';?>" required>
                            ...
                            <input value="<?= set_value('date') ?>" type="text" name="date" class="<?=!empty($errors['date']) ? 'error':'';?>" required>
                            <?php if(!empty($errors['date'])):?>
                            <?php endif;?><br>

                            <div class="btn">
                                <a href="<?=ROOT?>/officer/standardFare"><button id="submit_btn" class="submit_btn">Submit</button></a>
                                <a href="<?=ROOT?>/officer/standardFare"><small class="skip"><center>Cancel</center></small></a>
                            </div>
                        </div>
                    </form>
                </div>
