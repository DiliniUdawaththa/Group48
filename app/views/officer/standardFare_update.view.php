...
<body>
    <div class="main">
                ...
                <div class="officer_form">
                    <form name="addStandardFare" action="" method="post" onsubmit="return validateForm()">
                        <div class="officer_box">
                            ...
                            <input value="<?= $row->fare; ?>" type="text" name="fare"
                            ...
                            <input value="<?= $row->updatedby; ?>" type="text" name="updatedby"
                            ...
                            <input value="<?= $row->date; ?>" type="text" name="date"
        ...
        const categoryInput = document.getElementById('faretype');

        categoryInput.addEventListener('input', function() {
            const enteredValue = this.value;
            const options = document.getElementById('faretype_list').getElementsByTagName('option');
