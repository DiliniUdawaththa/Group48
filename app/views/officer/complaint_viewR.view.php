...
<head>
    <title>More Details of Rject Complaint</title>
...
<body>
    ...
    <div class='outer-box'>
        <div class="wrapper-box">
            ...
            <div class='content'>
                ...
                <h4>Officer Action: <?php echo isset($row->officerCmnt) ? $row->officerCmnt : 'N/A'; ?></h4>
    ...
    ok_button.addEventListener('click', () => {
        window.location.href = "<?=ROOT?>/Officer/rejectComplaint";
    })
    </script>
</body>
